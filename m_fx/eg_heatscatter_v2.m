...
if nStd==3 
    switch dynt
        case {'day','daytime','Day','DAY','Daytime','DAYTIME'};xlim = [250 340];
        case {'night','nighttime','Night','NIGHT','Nighttime','NIGHTTIME'};xlim = [230 320];
        case {'Allday','ALLDAY','allday'};xlim = [230 340];
    end
end 
if nStd==1
    xlim     = [250 340]
...
StName,'_',nSt,'st_',time_step,'_2004_2009_',dynt,'Std',num2str(nStd)]

tistrs  = {'Situ LST','Estimated LST',''} 
 
heatscatters(xx,yy,'40',tistrs,statistics)
...
print(fig,'-depsc2','-r300',['heatscatter_',FigName])
